# Contributing to Sentinel Pocket

Thank you for your interest in contributing to Sentinel Pocket! We welcome contributions of all kinds, whether you are fixing a bug, improving documentation, or proposing new features.
...
1. **Fork the repository** and clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/sentinel-pocket.git
   cd sentinel-pocket
   ```
...
Sentinel Pocket requires **Node.js 20+ LTS** and npm.
